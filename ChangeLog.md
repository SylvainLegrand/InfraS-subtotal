...
## Release 3.29 - OpenDSI
- FIX : Correction création / édition de ligne dans le dictionnaire 'Ligne de texte prédéfini' - **OPENDSI** - 3.29.4.1
- FIX : Correction gestion des colonnes TTC quand `MAIN_NO_INPUT_PRICE_WITH_TAX` est set. - **OPENDSI** - 3.29.5+0.0.1
